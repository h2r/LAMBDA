...
MODEL_CKPT='/users/ajaafar/data/ajaafar/LaNMP-Dataset/models/main_models/rt1/results/checkpoints/motionglot-nodist-task_split' #set to modify default for finetuning
