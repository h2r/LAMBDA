...
CHECKPOINT_DIR="results/checkpoints/train-${ARCH_TYPE}-${DIST}_dist-${SPLIT_TYPE}-${SUBSET_AMT}-scene${TEST_SCENE}-HP${HP}"
VAL_LOSS_DIR="results/val_losses/train-${ARCH_TYPE}-${DIST}_dist-${SPLIT_TYPE}-${SUBSET_AMT}-scene${TEST_SCENE}-HP${HP}"
EPOCHS=40
EVAL_FREQ=50
CHECKPOINT_FREQ=0
TRAIN_BATCH=3
