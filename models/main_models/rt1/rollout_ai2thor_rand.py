...
def main():
    ...
    dataset_manager = DatasetManager(args.subset_amt, False, args.test_scene, 0.8, 0.1, 0.1, split_style = args.split_type, diversity_scenes = args.num_diversity_scenes, max_trajectories = args.max_diversity_trajectories, dataset_path=args.dataset_path)
